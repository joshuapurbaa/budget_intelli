          ...
          bottomSheet: BottomSheetParent(
            ...
            child: BlocConsumer<TransactionsCubit, TransactionsState>(
              listener: (context, state) {
                if (state is UpdateItemCategoryTransactionSuccess) {
                  context.pop();
                ...
                if (state is UpdateItemCategoryTransactionFailed) {
                  context.pop();
                ...
                return AppButton.darkLabel(
                  ...
                  onPressed: () {
                    ...
                    if (itemId != null &&
                      ...
                      final newTransaction = ItemCategoryTransaction(
                        id: id,
                        itemHistoId: itemId,
                      ...
                      if (prevsAccount?.id != _selectedAccount?.id) {
                        final trxAmount = transaction.amount;
                        context.read<AccountBloc>().add(
                              UpdateAccountEvent(
                                prevsAccount!.copyWith(
                                  amount: prevsAccount.amount + trxAmount,
                                ),
                              ),
                            );
                        context
                        ...
                        if (trxAmount != amount) {
                          ...
                          final updatedAccount = prevsAccount!.copyWith(
                            amount: prevsAccount.amount + diff,
                          );

                          context.read<AccountBloc>().add(
                                UpdateAccountEvent(updatedAccount),
                              );
                        }
                    ...
                    [
                      ...
                      AppButton.outlined(
                        ...
                        onPressed: () async {
                          ...
                          final contentText = localize.confirmDeleteTransaction;
