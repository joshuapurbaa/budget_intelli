...
class SignUpScreenFromProfile extends StatefulWidget {
  const SignUpScreenFromProfile({super.key});

  @override
  State<SignUpScreenFromProfile> createState() =>
      _SignUpScreenFromProfileState();
}

class _SignUpScreenFromProfileState extends State<SignUpScreenFromProfile> {
  ...
  void _onSuccessAuth(AuthSuccess state) {
    context.read<SettingBloc>().add(SetUserUidEvent(state.user.uid));
